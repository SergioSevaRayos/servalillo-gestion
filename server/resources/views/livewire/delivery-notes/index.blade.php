<div>
    ...
    <div class="mb-4 flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <input type="date" wire:model.live="from" class="rounded-lg border-slate-300 shadow-soft-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 lg:text-sm" />
        <input type="date" wire:model.live="to" class="rounded-lg border-slate-300 shadow-soft-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 lg:text-sm" />
