...
it('guarda la ubicación de la base y el umbral de parada no programada', function () {
    Livewire::actingAs(makeUser('mantenimiento'))
        ->test(Settings::class)
...
it('una vez guardado, un nuevo montaje carga los valores guardados, no los del .env', function () {
    CompanySetting::current()->update(['base_latitude' => 41.0, 'base_longitude' => -1.0, 'unplanned_stop_minutes' => 7]);
